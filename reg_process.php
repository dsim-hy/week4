            ...
            <nav class="navbar navbar-expand-xl yamm">
                ...
                <ul class="nav navbar-nav nav-justified w-100">
                    ...
                    <li class="nav-item" id="menu1">
                        <a class="nav-link" href="pfizerBioNTech.html">Pfizer</a>
                    </li>
        ...
        <main class="col-xl-9 order-xl-2">
            ...
            <div class="row">
                ...
                <div class="col content">
                    ...
                    <div class="row">
                        <br>
                        <h2 id="content" class="open d-lg-block">Registration for COVID-19 Vaccination</h2>
                        <br>
                        <br>
                        <br>
                    ...
                    <div class="syndicate">
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="color-bar cyan half"></div>
                                    <div></div>
                                    <div></div>
                                    <div></div>
								</div>
